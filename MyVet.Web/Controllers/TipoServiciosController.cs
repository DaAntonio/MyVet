...
namespace MyVet.Web.Controllers
{
    public class TipoServiciosController : Controller
    {
        ...
        public TipoServiciosController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Valor")] TipoServicio tipoServicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Valor")] TipoServicio tipoServicio)
        {
