...
namespace MyVet.Web.Controllers
{
    public class TipoMascotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Valor")] TipoMascota tipoMascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Valor")] TipoMascota tipoMascota)
        {
